...
?>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="free-text">
                <b><?= Yii::$app->name; ?> Username Request</b>
            </td>
          </tr>
          <tr>
